...
export const Header = ({setFilter, filter, input, setInput, setIsSearch}) => (
    <div className="buttons-container">
        <div className={"button Arr " + (filter===1 && !input ? "active" : "inactive")} onClick={() => setFilter(1)}>Arrived</div>
        <div className={"button Dep " + (filter===2 && !input ? "active" : "inactive")} onClick={() => setFilter(2)}>Departed</div>
